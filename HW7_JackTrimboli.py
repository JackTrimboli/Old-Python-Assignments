...
def litCricFriend(wordList, text):
    """ The Literary Critic's Friend helps the humanities scholar    by computing and returning the frequency with which specified words    (wordList) appear in a body of text (text). Frequency is    the sum of the number of times that each word in wordList    occurs, divided by the number of words in the text. A word    occurrence is the whole word, regardless of case, and    excluding punctuation."""
    ...
    return float(count / len(newList))
...
print("Freq of 'a' and 'an' in The Bells: " + litCricFriend(["a", "an"], theBells))
print("Freq of 'the' in The Bells: " + litCricFriend(["the"], theBells))
print("Freq of 'a' and 'an' in cantoXII: " + litCricFriend(["a", "an"], cantoXII))
print("Freq of 'the' in cantoXII: " + litCricFriend(["the"], cantoXII))
...
"""Put your answer to PROBLEM 8 here.
    ANSWER:
    Neruda using 'the', 'an', and 'a' less than poe.
